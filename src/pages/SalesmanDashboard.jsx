...
const SalesmanDashboard = () => {
  ...
  const headerBg = useColorModeValue("orange.500", "orange.300");
  const cardBg = useColorModeValue("gray.800", "gray.700");

  return (
    <Box bg={bg} color={color} minH="100vh">
      <Flex as="header" bg={headerBg} color="white" p={4} justifyContent="space-between" alignItems="center">
        <HStack spacing={4}>
      ...
      <Flex direction={{ base: "column", md: "row" }} p={4}>
        <Box flex="1" p={4}>
          ...
          <VStack spacing={4}>
            <Box bg={cardBg} p={4} rounded="md" shadow="md" width="full">
      ...
      <Flex as="footer" bg={headerBg} color="white" p={4} justifyContent="space-between" alignItems="center">
        <HStack spacing={4}>
